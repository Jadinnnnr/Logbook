...
export default async function PerformancePage({
  ...
  return (
    <main className="container">
      ...
      <PerformanceCalculator seed={seed} />

      <p className="muted" style={{ fontSize: 12, maxWidth: 760 }}>
        Pressure and density altitude are computed from the International Standard Atmosphere.
        Distances come only from the numbers you copy out of your own AFM/POH — this app has no
        performance data for any aircraft and does not estimate any. None of it replaces the book,
        and none of it is an official preflight briefing.
      </p>
    </main>
  );
}
