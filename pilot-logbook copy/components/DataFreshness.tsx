...
export default function DataFreshness({
  ...
  return (
    <div className="card data-freshness">
      ...
      <RefreshProgress initialStatus={status} initialRunning={running} />
            ...
            <li key={d.key}>
              <span
                className={`freshness-dot ${
                  !d.present
                    ? "missing"
                    : // A partial build is not "fresh", however recent it is.
                      d.incomplete || isStale || !d.builtAt
                      ? "stale"
                      : "fresh"
                }`}
                aria-hidden
              ...
              {d.incomplete && <span className="freshness-incomplete">⚠ {d.incomplete}</span>}
            </li>
          );
        })}
      </ul>
